  ...
  try
    {
      ...
      LOG_ERROR ("STARTUP: MultiSettings loaded");
      ...
      LOG_ERROR ("STARTUP: instance lock acquired");

      // load UI translations
      L10nLoader l10n {&a, locale, parser.value (lang_option)};
      LOG_ERROR ("STARTUP: L10nLoader done");
      ...
      while (!temp_ok);
      LOG_ERROR ("STARTUP: temp directory ready");
      ...
      LOG_ERROR ("STARTUP: database open");
      ...
      do
        {
          ...
          mem_jt9.unlock ();
          LOG_ERROR ("STARTUP: shared memory / jt9 ready");
          ...
          LOG_ERROR ("STARTUP: creating MainWindow");
          MainWindow w(temp_dir, multiple, &multi_settings, &mem_jt9, downSampleFactor, &splash, env);
          LOG_ERROR ("STARTUP: MainWindow created, showing");
          w.show();
          splash.raise ();
          ...
          QObject::connect (&unixSignalHandler, &UnixSignalHandler::sigHUP, &w, &MainWindow::close);
          QObject::connect (&unixSignalHandler, &UnixSignalHandler::sigTERM, &w, &MainWindow::close);
          QObject::connect (&unixSignalHandler, &UnixSignalHandler::sigINT, &w, &MainWindow::close);
          LOG_INFO ("Unix signal handlers installed");
