...
# Hamlib's network backends use Winsock2 (WSAGetLastError) and IP Helper
# (GetAdaptersAddresses). When pkg-config IS used, the WIN32 ws2_32 carve-out
# above is skipped and the link fails. Append the needed Win32 system libs
# unconditionally so they land AFTER libhamlib.a in the link order
# (static-linker symbol resolution is left-to-right).
if (WIN32 AND Hamlib_FOUND)
  list (APPEND Hamlib_LIBRARIES ws2_32 iphlpapi)
endif ()
