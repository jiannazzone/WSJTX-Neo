...
! Detect receiver filter edges from the smoothed spectrum.
! Find the passband noise level from the middle half of the range,
! then trim nfa/nfb to exclude the filter rolloff region.
  npts_filt=nfb-nfa+1
