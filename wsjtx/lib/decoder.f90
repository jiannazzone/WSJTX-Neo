...
!ft8md added 3 uses below
  ...
  integer, parameter :: FT2_NMAX=23*1728
  integer, parameter :: FT4_NMAX=23*3456
...
1004             format(a12,1x,a4,i5,i6,i7,i3)
  ...
  if(params%nmode.eq.5) then
     call timer('decft4  ',0)
     call my_ft4%decode(ft4_decoded,id2,params%nutc,params%nQSOProgress,     &
          params%nfqso,params%nfa,params%nfb,params%ndepth,                  &
          logical(params%lapcqonly),ncontest,mycall,hiscall,7.5)
     call timer('decft4  ',1)
     go to 800
  endif
  ...
  if(params%nmode.eq.52) then
     ...
     enddo
     call timer('decft2  ',0)
     call my_ft4%decode(ft2_decoded,id2_ft4,params%nutc,params%nQSOProgress, &
          nfqso_ft2,nfa_ft2,nfb_ft2,params%ndepth,                          &
          logical(params%lapcqonly),ncontest,mycall,hiscall,3.75)
     call timer('decft2  ',1)
     go to 800
  endif
