...
public:
  ...
  // Decoded-callsign overlay (N6NU port of QMAP feature 2026-05-11).
  // WideGraph pushes the current set of fresh labels here; we render
  // them on top of the waterfall at the audio-offset x-position.
...
private:
  ...
  // Called from paintEvent after the waterfall is drawn.
