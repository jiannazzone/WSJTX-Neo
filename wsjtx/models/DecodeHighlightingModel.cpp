...
QList<DecodeHighlightingModel::HighlightInfo> const DecodeHighlightingModel::impl::defaults_ = {
  ...
  , {Highlight::USState, true, {}, {{0xb4, 0x69, 0xff}}}
  , {Highlight::USStateBand, true, {}, {{0xd2, 0xa5, 0xff}}}
...
QList<DecodeHighlightingModel::HighlightInfo> const DecodeHighlightingModel::impl::defaults2_ = {
  ...
  , {Highlight::CQZoneBand, false, {{0xaa, 0x00, 0x00}}, {{0xaa, 0xaa, 0x7f}}}
  , {Highlight::ITUZone, true, {{0xaa, 0x00, 0x00}}, {{0x37, 0xbd, 0xff}}}
  , {Highlight::ITUZoneBand, false, {{0xaa, 0x00, 0x00}}, {{0x91, 0xde, 0xff}}}
  , {Highlight::USState, true, {{0xaa, 0x00, 0x00}}, {{0xb4, 0x69, 0xff}}}
  , {Highlight::USStateBand, true, {{0xaa, 0x00, 0x00}}, {{0xd2, 0xa5, 0xff}}}
  , {Highlight::Grid, true, {{0xaa, 0x00, 0x00}}, {{0xff, 0xa8, 0x80}}}
  , {Highlight::GridBand, false, {{0xaa, 0x00, 0x00}}, {{0xff, 0xcd, 0x9b}}}
...
QString DecodeHighlightingModel::highlight_name (Highlight h)
{
  switch (h)
    ...
    case Highlight::USState: return tr ("New US State");
    case Highlight::USStateBand: return tr ("New US State on Band");
    }
  return "Unknown";
}
